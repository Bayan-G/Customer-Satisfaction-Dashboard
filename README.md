...
### Overview
The Customer Satisfaction Dashboard provides a comprehensive view of customer feedback and experience across multiple dimensions. The dashboard enables stakeholders to track satisfaction levels, service quality, staff performance, and customer loyalty using survey data.
This project aims to transform raw survey responses into actionable insights that support data-driven decision-making and service improvement initiatives.

### Data Collection
Customer feedback was collected using Google Forms, the Customer Satisfaction Survey includes Questions which are:
- User demographics (name, email, age, region, and gender).
